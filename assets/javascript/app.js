...
// Update the latest information in the table using Firebase as user adds new information
// Use moment.js for Next Arrival and Minutes Away
function updateTable() {
    firebase
        ...
        var firstTimeConverted = moment(trainFirstDeparture, "HH:mm").subtract(
            1,
            "years"
        );
...
// Execute updateTable function
updateTable();

// Update information in the table every 60 seconds 
// This is to update Next Arrival and Minutes Away as time passes (moment.js) without reloading the page
